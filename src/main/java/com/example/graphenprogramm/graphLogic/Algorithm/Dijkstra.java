...
public class Dijkstra extends Algorithm {
     ...
     */
    public void calculate(boolean debug) {
        ...
        while (node != startNode && node.getShortestNode() != null) {
            ...
            //Get all nodes and edges on the way and edd them
            Node finalNode = node;
            Controller.nodes.forEach(nodeUI -> {
                ...
                nodeUI.edges.forEach(edge -> {
                    if ((edge.EDGE.getNode1().getKey().equals(finalNode) && edge.EDGE.getNode2().getKey().equals(finalNode.getShortestNode()))
                            || (edge.EDGE.getNode1().getKey().equals(finalNode.getShortestNode()) && edge.EDGE.getNode2().getKey().equals(finalNode))) {
     ...
     */
    public void moveToChecked(Node nodeToMove) {
